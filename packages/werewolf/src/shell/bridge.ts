 ...
 *
 *   - `mode: "shared_admin_input"` maps to UX "party" — Werewolf's primary
 *     supported mode. With this, the picker is always usable in dev.
 *   - `seat: "participant"` so the variant is the controller surface (with
 *     action buttons) and the dev/solo user can actually interact.
 *
