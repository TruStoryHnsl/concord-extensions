 ...
 * (and the InputRouter/ExtensionEmbed type definitions next to it).
 *
 ...
 * just the types we need here, so the extension can compile + run
 * standalone (and inside the iframe at runtime).
 *
...
/** Surface anchor / type — kept loose to mirror upstream without importing. */
